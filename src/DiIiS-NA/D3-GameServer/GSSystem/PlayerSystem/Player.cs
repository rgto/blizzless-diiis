...
public partial class Player : Actor, IMessageConsumer, IUpdateable
{
...
{
    // 396751 - X1_OpenWorld_Tiered_Rifts_Portal - Great Portal
    // 345935 - X1_OpenWorld_LootRunPortal - Regular Portals
    // 408511 - X1_OpenWorld_Tiered_Rifts_Challenge_Portal

    // 1073741824 - First level of the enhanced Great Rift
    // 0 - First level of the Great Rift
    var activated = false;
    ...
    var maps = new WorldSno[]
    {
        ...
        WorldSno.x1_lr_tileset_fortress_large, // x1_lr_tileset_fortress_large
        ...
        case -1:
            ...
            default:
                ...
                altBoom.ContinueWith(delegate
                {
                    ...
                    // The GR closing process begins at the same time as the GR itself, as the accountant must start here.
                    // This process can be renewed and canceled to extend the GR closing time.
                    GreaterRiftManager.StartGreaterRiftCloseTimer(World, portal, lootRunObelisk, nephalemPWorld, 15f);
                });
                break;
